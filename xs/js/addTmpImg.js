...
var urlId
function uploadfiles(addUrl,bj_id,url,name,type,token){
    $.ajax({
        url:"/cszyylfw"+addUrl,
        type:'post',
        async: false,
        cache: false,
        processData: false,
        data:'token='+token+"&qj_id="+bj_id+"&url="+url+"&type="+type+"&name="+name,
...
var urlId2
function uploadfilesxqId(addUrl,bj_id,url,name,type,token){
    $.ajax({
        url:"/cszyylfw"+addUrl,
        type:'post',
        async: false,
        cache: false,
        processData: false,
        data:'token='+token+"&xq_id="+bj_id+"&url="+url+"&type="+type+"&name="+name,
        success:function(res){
            if(res.code==0){
                urlId2 = res.data.id;
                return urlId2;
...
var urlId3
function uploadfilesgtId(addUrl,bj_id,url,name,type,token){
    $.ajax({
        url:"/cszyylfw"+addUrl,
        type:'post',
        async: false,
        cache: false,
        processData: false,
        data:'token='+token+"&gt_id="+bj_id+"&url="+url+"&type="+type+"&name="+name,
        success:function(res){
            if(res.code==0){
                urlId3 = res.data.id;
                return urlId3;
...
var urlId4
function uploadfileshdcyId(addUrl,bj_id,url,name,type,token){
    $.ajax({
        url:"/cszyylfw"+addUrl,
        type:'post',
        async: false,
        cache: false,
        processData: false,
        data:'token='+token+"&hdcy_id="+bj_id+"&url="+url+"&type="+type+"&name="+name,
        success:function(res){
            if(res.code==0){
                urlId4 = res.data.id;
                return urlId4
...
var urlId5
function uploadfilesnlId(addUrl,bj_id,url,name,type,token){
    $.ajax({
        url:"/cszyylfw"+addUrl,
        type:'post',
        async: false,
        cache: false,
        processData: false,
        data:'token='+token+"&nl_id="+bj_id+"&url="+url+"&type="+type+"&name="+name,
        success:function(res){
            if(res.code==0){
                urlId5 = res.data.id;
                return urlId5;
...
var urlIdcddy
function uploadfilescddy(addUrl,cddybg_id,url,name,type,token){
    if(url){
        $.ajax({
            url:"/cszyylfw"+addUrl,
            type:'post',
...
var urlIdhdgg
function uploadfileshdgg(addUrl,hdgg_id,url,name,type,token){
   if(url){
       $.ajax({
           url:"/cszyylfw"+addUrl,
           type:'post',
...
var urlIdyqh
function uploadfilesyqh(addUrl,yqh_id,url,name,type,token){
   if(url){
       $.ajax({
           url:"/cszyylfw"+addUrl,
           type:'post',
